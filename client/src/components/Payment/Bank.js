...
import {
  ...
  updateBank,
  getDetailBank,
} from "../../actions/Payment/bankAction";
...
const Bank = () => {
  const {
    ...
    deleteBanksResult,
    updateBanksResult,
    getDetailBanksResult,
  } = useSelector((state) => state.BanksReducer);
                        ...
                        <td>
                          <div class="d-grid">
                            <button
                              ...
                              onClick={() =>
                                dispatch(getDetailBank(entity.bank_entity_id))
                              }
                            >
                              <FaEdit /> Edit
                            </button>
                        ...
                        <td>
                          <div className="d-grid">
                            <button
                              ...
                              onClick={() =>
                                dispatch(deleteBank(entity.bank_entity_id))
                              }
                            >
                              <FaTrash /> Delete
                            </button>
