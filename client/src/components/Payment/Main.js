    ...
    <div>
      <div id="wrapper">
        ...
        <div id="content-wrapper" className="d-flex flex-column">
          ...
          <div id="content">
            ...
            <nav className="navbar navbar-expand navbar-light topbar mb-4 static-top shadow" style={{ backgroundColor: "#363062" }}>
              ...
              <ul className="navbar-nav ml-auto">
                ...
                {/* Nav Item - Messages */}
                <li className="nav-item dropdown no-arrow mx-1">
                  <a className="nav-link dropdown-toggle" href="#" id="messagesDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
          ...
          <footer className="sticky-footer" style={{ backgroundColor: "#363062" }}>
